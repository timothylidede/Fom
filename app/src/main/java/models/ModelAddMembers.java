...
public class ModelAddMembers {
    ...
    public ModelAddMembers(){}

    public ModelAddMembers(String display_name, String username, String image_one, String image_two, String image_three, String user_id) {
