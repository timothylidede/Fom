...
public class AdapterConnection extends RecyclerView.Adapter<AdapterConnection.ConnectionHolder> {
    ...
    public AdapterConnection(Context context, ArrayList<ModelConnection> connectionList) {
