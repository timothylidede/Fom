...
public class AdapterMyPacks extends RecyclerView.Adapter<AdapterMyPacks.PackHolder> {
    ...
    //constructor
    public AdapterMyPacks(Context context, ArrayList<ModelMyPacks> myPacksList) {
